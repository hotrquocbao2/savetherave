...
<template>
    <div class="max-w-7xl mx-auto fl-px-2/8">
        <div class="iframely-embed fl-mb-8/16">
            <div class="gfm-embed" data-url="https://www.gofundme.com/f/gemeinsam-machen-wir-die-tagtanzdemo-2026-moglich/widget/large"></div>
        </div>
        <div
        ...
        >
            ...
            <div class="grid__item text-2xl gap-2 flex flex-col lg:col-span-4">
                <p>Wann:</p>
                <h2 class="font-bold">19.09.2026, 12 Uhr</h2>
            </div>
            <div class="grid__item text-2xl gap-2 flex flex-col lg:col-span-4">
                <p>Wo:</p>
